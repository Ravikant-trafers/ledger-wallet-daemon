...
tests=(transactionsPartialTest currency_pool test_pool test_pool1 test_pool2 test_pool3 op_pool op_pool_mal info_pool exist_pool fresh_addresses_pool list_pool account_pool delete_pool delete_account balance_pool pool_1 pool_2 pool_3 random_pool multi_pool_mal transactionsCreation4Test ledger anotha_pool same_pool this_pool my_pool your_pool wallet_pool duplicate_pool empty_pool multi_pool random POOL_NAME myPool test_wallet getUtxo_pool )
